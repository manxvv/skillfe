...
const InvestorInterestedPitch = () => {
  ...
  // };
  useEffect(() => {
    dispatch(DeckManagementActions.getInvestorInterestedPitch())
  }, [])
  let interestedPitch = useSelector((state) => {
    console.log(state?.deckManagement?.investorInterestedPitchList, "asdfasfasfasdnslfsfdmsasfas")
    return state?.deckManagement?.investorInterestedPitchList;
  })
  console.log("jfksdfaskdflasdfgsdfgkf", interestedPitch);
  ...
  let dbConfigList = useSelector((state) => {
    ...
    let interdata = state?.deckManagement?.investorInterestedPitchList || []
    console.log("fasfassfsfsdrefefadsafdasf", interdata);
            ...
            child={
              <Button
                ...
                onClick={() => {
                  ...
                  dispatch(
                    DeckManagementActions.postFundseekerStatus(datass, itm.uniqueId)
                  );
                  let msgdata = {
                    show: true,
                    icon: "success",
...
export default InvestorInterestedPitch;
