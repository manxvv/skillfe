...
const PitchDeckForm = ({ isOpen, setIsOpen, resetting, formValue = {} }) => {
  ...
  let Form = [
    ...
    },
    {
      ...
      props: {
        onChange: ((e) => {
          console.log("asfasfasfasads", e);
          if (e.target.value === "Other") {
            setCustomStage(e.target.value);
            console.log("sfasfasdfadsasd", customStage);
          } else {
            setCustomStage("");
          }
        })
  ...
  return (
    <>
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <CommonForm
          classes={`grid-cols-1 gap-1 ${!mode? "  text-black":""}`}
          Form={Form}
          errors={errors}
          register={register}
          setValue={setValue}
        ...
        <div class="grid h-fit grid-cols-1 gap-2 rounded-md ">
          <div className="col-span-1 h-full pt-0 overflow-scroll relative border-gray-200 border rounded-md">
            <div className="flex w-full sticky top-0 justify-between bg-primaryLine py-2 pt-0 rounded-md">
              <h1 className="text-white">
                <p className="mt-2 font-oxygen font-semibold ms-2 ">Upload Pitch Documents</p>
              </h1>
              <button
                onClick={() => {
                  let finval = 0;
