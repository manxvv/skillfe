...
// import FundSeekerDetailsActions from '../../../store/actions/adminManagement-actions';
import FundSeekerDetailsActions from '../../store/actions/FundSeekerDetails-actions';
const FundSeekerDetailsForm = ({ isOpen, setIsOpen, resetting, formValue = {} }) => {
    ...
    const onTableViewSubmit = (data) => {
        ...
        if (formValue.uniqueId) {
            ...
            dispatch(FundSeekerDetailsActions.postOperationUserList(true, data, () => {
...
export default FundSeekerDetailsForm;