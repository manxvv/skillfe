...
const OperationManagementForm = ({ isOpen, setIsOpen, resetting, formValue = {} }) => {
    ...
    const onTableViewSubmit = (data) => {
        ...
        if (formValue.uniqueId) {
            ...
            dispatch(OperationManagementActions.postOperationUserList(true, data, () => {
...
export default OperationManagementForm;