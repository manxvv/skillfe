...
const InvestmentDetailsManagement = () => {
            ...
            child={
              <EditButton
                ...
                onClick={() => {
                  ...
                  setmodalBody(
                    <>
                      <InvestmentDetailsManagementForm
                        isOpen={modalOpen}
                        ...
                        onClick={() => {
                          dispatch(
                            CommonActions.deleteApiCaller(
                              `${Urls.investmentDetails}/${itm.uniqueId}`,
                              () => {
                                dispatch(
                                  InvestmentDetailsActions.getInvestmentDetailsList()
                                );
  ...
  return (
    <div className={`font-poppins ${!mode ? "bg-darkBg  ": ""} `}>
      <AdvancedTable
        headerButton={
          <>
            <Button
