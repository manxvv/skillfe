...
const operationManagement = createSlice({
...
export const {  USERS_LIST, KYC_STATUS, RESET_STATE } = operationManagement.actions
export default operationManagement.reducer
