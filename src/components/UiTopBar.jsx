...
const UiTopBar = ({ sidebarOpen, setsidebarOpenn }) => {
    ...
    return <>
        ...
        <div class="flex justify-between ml-0 px-3 py-4 overflow-y-auto duration-150 ">
            ...
            {/* </div> */}
            <div className="mx-auto font-kat text-txt-neavy text-5xl text-center dark:text-darkBg transition-all duration-500 hover:scale-110 flex justify-center items-center">
                <img src='../../../Amansas_logo.png' className='w-1/2' />
            </div>
